  ...
  document.addEventListener('click', (event) =>{
    if (event.target.classList.contains('link-item')) {
      ...
      if (event.target.hash !== "") {
        // pravent default anchor click behavior
        event.preventDefault();
        const hash = event.target.hash;
        // deactive exixting active section
...
(() => {
  ...
  function popupSlideshow() {
    ...
    popupImg.src = imgSrc;
    popupImg.onload = () => {
      // deactive loader after the popupImg loader
  ...
  function popupDetails() {
    ...
    projectDetailsBtn.style.display = 'blok';
  ...
  function popupDetailsToggle() {
    if (projectDetailsContainer.classList.contains('active')) {
      ...
      projectDetailsContainer.style.maxHeight = projectDetailsContainer.scrollHeight = 0 + 'px';
...
window.addEventListener('load', () => {
  // preloader
  document.querySelector('.preloader').classList.add('fade-oute');
  setTimeout(() => {
